// FaithX Infinity - Main JavaScript File
...
// Show success notification for pledge creation
if (window.location.search.includes('pledge_created=1')) {
    document.addEventListener('DOMContentLoaded', function() {
        showSuccessModal(
            'Pledge created successfully!', 
            'Your pledge has been recorded and will appear in your dashboard shortly.'
        );
    });
}
